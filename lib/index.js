...
module.exports = {
    ...
    getCommandFn: function(options, config) {
        ...
        return typeof cmd === "function" ? cmd :  fnHelp;
    },
     ...
     *
     * Options:
     *   - `[options]` {Object}  - Options for `getConfig()` and `getCommandFn()` methods.
     */ 
    run: function(options) {
        var config = this.getConfig(options);
        var fnCmd = this.getCommandFn(options, config);
